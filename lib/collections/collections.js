...
ShopReviews.attachSchema(Schemas.ShopReviews);
...
ShopRatings.attachSchema(Schemas.ShopRatings);

/**
 * ProductRatings Collection
 */
export const ProductRatings = new Mongo.Collection("ProductRatings");

ProductRatings.attachSchema(Schemas.ProductRatings);
